...
/**
 * @file
 * Provides the theme settings for the Autodesk theme.
 */

/**
 * Implements Theme Specific Settings for Autodesk Bootstrap.
 */
function autodesk_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $size = autodesk_devconnect_logo_size_example($form, $form_state);
  $form['devconnect_settings']['logo_variant']['logo_size'] = array(
    ...
    '#submit' => array('autodesk_devconnect_logo_size_submit'),
    '#ajax' => array(
      'wrapper' => 'logo-size-example',
      'callback' => 'autodesk_devconnect_logo_size_example',
      'effect' => 'fade',
      'progress' => 'none',
    ),
    '#suffix' => $size,
 ...
 */
function autodesk_devconnect_logo_size_example($form, $form_state) {
