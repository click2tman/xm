...
<?php if ($application_count): ?>
  <div class="row">
    <div class="col-sm-12">
      <h2 class="featurette-heading"><?php print t("$plural_downcase!"); ?>
  ...
  <?php foreach ($applications as $app): ?>
    <?php $status = apigee_responsive_autodesk_app_status($app); ?>
          ...
          <h4 class="panel-title">
            <div class="truncate">
              ...
              <a data-toggle="collapse" data-parent="#my-apps-accordion" href="#my-apps-collapse<?php print $i; ?>"><strong><?php print $app['app_name']; ?></strong></a>
                <br /><?php print $app['dev_portal_app_description']; ?>  This text will be replaced with text entered in the description field
            </div>
            <div class="status-label"><strong>Created </strong><?php print format_date($app['credential']['issued']); ?></div>
          </h4>
        </div>
    ...
    <?php endif; ?>
        ...
        <?php if ($status == 'Approved'): ?>
                        <tr>
                          <td class="key"><strong><?php print t('Key Expiration'); ?></strong></td>
        ...
        <?php endif; ?>
                              ...
                              <td width="30%">
                                   <table>  
                                             <tr>
                          <td class="key"><strong><?php print t('Products'); ?></strong></td>
                          <td>
                                         <ul>
                                         <li>This is a dummy product</li>
                                         <li>This is a dummy product</li>
                                         <li>This is a dummy product</li>
                                         <li>This is a dummy product</li>
                                         </ul>
