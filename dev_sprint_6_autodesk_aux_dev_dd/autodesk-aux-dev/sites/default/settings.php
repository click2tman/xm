...
$conf['reroute_email_address'] = "tamba.s.lamin@accenture.com";
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_dev_sprint_6_autodesk_aux_dev_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_dev_sprint_6_autodesk_aux_dev_dd.inc';
}
// </DDSETTINGS>
